...
const UI = {
  en:{flashcards:"Flashcards",lessons:"Lessons",home_title:"Choose what to study",
    ...
    history:"History",history_title:"History",
    history_empty:"Nothing here yet. Finish a deck or a game and it lands here.",
    history_signin:"Signed in, this also shows the sessions from the kanji site.",
    history_unfinished:"not finished",history_continue:"Continue",
    history_gone:"That session is no longer on this device.",
    site_vocab:"語彙",site_kanji:"漢字",
  ...
  ru:{flashcards:"Карточки",lessons:"Уроки",home_title:"Что будем учить?",
    ...
    history:"История",history_title:"История",
    history_empty:"Пока пусто. Пройдите карточки или викторину — и они появятся здесь.",
    history_signin:"После входа здесь появятся и занятия с сайта кандзи.",
    history_unfinished:"не закончено",history_continue:"Продолжить",
    history_gone:"Это занятие больше не сохранено на устройстве.",
    site_vocab:"語彙",site_kanji:"漢字",
  ...
  hy:{flashcards:"Քարտեր",lessons:"Դասեր",home_title:"Ի՞նչ սովորենք",
    ...
    history:"Պատմություն",history_title:"Պատմություն",
    history_empty:"Դեռ դատարկ է։ Ավարտիր քարտերը կամ խաղը, և դրանք կհայտնվեն այստեղ։",
    history_signin:"Մուտք գործելուց հետո այստեղ կերևան նաև կանջիի կայքի պարապմունքները։",
    history_unfinished:"անավարտ",history_continue:"Շարունակել",
    history_gone:"Այդ պարապմունքն այլևս պահված չէ այս սարքում։",
    site_vocab:"語彙",site_kanji:"漢字",
